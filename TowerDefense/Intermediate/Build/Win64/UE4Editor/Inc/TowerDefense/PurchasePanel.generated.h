...
#ifdef TOWERDEFENSE_PurchasePanel_generated_h
#error "PurchasePanel.generated.h already included, missing '#pragma once' in PurchasePanel.h"
#endif
...
#define TowerDefense_Source_TowerDefense_UI_PurchasePanel_h_17_RPC_WRAPPERS \
 \
	...
	DECLARE_FUNCTION(execCatapultSelected); \
	DECLARE_FUNCTION(execCannonSelected); \
	DECLARE_FUNCTION(execBallistaSelected); \
...
public: \
	DECLARE_CLASS(UPurchasePanel, UUserWidget, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/TowerDefense"), NO_API) \
...
#define TowerDefense_Source_TowerDefense_UI_PurchasePanel_h_17_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UPurchasePanel); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UPurchasePanel); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UPurchasePanel(UPurchasePanel&&); \
	NO_API UPurchasePanel(const UPurchasePanel&); \
public:
...
template<> TOWERDEFENSE_API UClass* StaticClass<class UPurchasePanel>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID TowerDefense_Source_TowerDefense_UI_PurchasePanel_h
