...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATowerDefensePlayer_Statics::NewProp_CameraBoom_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Camera" },
		{ "Comment", "// Components for camera and camera boom\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "TowerDefensePlayer.h" },
		{ "ToolTip", "Components for camera and camera boom" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ATowerDefensePlayer_Statics::NewProp_PawnMovement_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Camera" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ATowerDefensePlayer_Statics::NewProp_PawnMovement = { "PawnMovement", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ATowerDefensePlayer, PawnMovement), Z_Construct_UClass_UMovementComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ATowerDefensePlayer_Statics::NewProp_PawnMovement_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ATowerDefensePlayer_Statics::NewProp_PawnMovement_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ATowerDefensePlayer_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ATowerDefensePlayer_Statics::NewProp_PawnMovement,
	...
	IMPLEMENT_CLASS(ATowerDefensePlayer, 3888324409);
